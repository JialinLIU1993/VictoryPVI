...
const source = fs.readFileSync(new URL('../direct-sync-client.js', import.meta.url), 'utf8');
...
const Client = context.VictoryPVIDirectClient;
...
try {
  ...
  console.log('direct-sync-smoke: codec, no online transports, multiple mirrors, late join, large chunks, ACK, outage recovery, dedupe, stale heartbeat: ok');
