...
assert.ok(indexHtml.includes(`/releases/download/desktop-v${release.version}/VictoryPVI-Windows-x64.zip`));
assert.ok(indexHtml.includes(`/releases/download/desktop-v${release.version}/VictoryPVI-macOS.zip`));
...
assert.match(appScript, /restoreSyncSession/);
